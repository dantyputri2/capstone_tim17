...
st.sidebar.page_link("https://streamlit.io/gallery", label="Chatbot", icon="🤖")
st.sidebar.page_link("pages/pinjaman.py", label="Prediksi Kelayakan Pinjaman", icon="📈")
...
with col2:
    ...
    st.page_link("https://streamlit.io/gallery", label="Chatbot", icon="🤖")
    ...
    st.page_link("pages/pinjaman.py", label="Prediksi Kelayakan Pinjaman", icon="📈")
